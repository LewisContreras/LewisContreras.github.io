    ...
    return (
        <Box boxShadow="base" display="flex" alignItems="center" position="fixed" top="0" w="100vw"  bgColor="primary" zIndex="10" h={["80px","60px"]} >
          ...
          <VStack className="scene_fast scene_element--clippathdown"  display={!menu ? "none" : "flex"}  bgColor="primary" position="absolute" top="70px" width="100vw" zIndex="10" >
            <Link _hover={{textDecoration:"none"}} _focus={{outline:"none"}}  href="#welcome" py="4px" width="100%" textAlign="center" borderTop="2px solid" borderColor="terciary" color="terciary" >{language ? "Bienvenido" : "Welcome" }</Link>
            <Link _hover={{textDecoration:"none"}} _focus={{outline:"none"}}  href="#projects" py="4px" width="100%" textAlign="center" borderTop="2px solid" borderColor="terciary" color="terciary" >{language ? "Proyectos" : "Projects" }</Link>
            {/* <Link py="4px" width="100%" textAlign="center" borderTop="2px solid" borderColor="terciary" color="terciary" >Technologies</Link> */}
            <Link href="#contact" _hover={{textDecoration:"none"}} _focus={{outline:"none"}}  py="4px" pb="10px" width="100%" textAlign="center" borderTop="2px solid" borderColor="terciary" color="terciary" >{language ? "Contacto" : "Contact" }</Link>
          </VStack>
        </Box>
    )
}
