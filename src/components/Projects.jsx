...
const Projects = () => {
    return (
        <Box id="projects" py="90px" px="5%" bgColor="secondary" w="100vw" >
            ...
            <Grid gridTemplateColumns={["1fr","1fr 1fr"]} templateRows={["0.5fr 1fr 600px 600px 600px","1fr 540px 350px"]} gap="40px">
                ...
                <GridItem colSpan={["1","2"]} borderRadius="4px" bgImage={["url('https://i.imgur.com/rwfsmdJ.png')","url('https://i.imgur.com/jvChYsG.png')" ]}bgPosition="center" bgRepeat="no-repeat" boxShadow="2xl" bgSize="cover" position="relative" zIndex="0" >
                    <Box boxShadow="2xl" borderRadius="8px" position="absolute" p="10px" bottom="30px" left="-10px" bgColor="primary" w={["95%","50%"]} height="40%" >
                        ...
                        <Text fontSize={["xl","xl","xl","2xl"]} color="terciary" > Revive una tienda icónica para rentar películas.</Text>
                ...
                <GridItem borderRadius="4px" bgImage={["url('https://i.imgur.com/nx7EOsb.png')","url('https://i.imgur.com/cqnEQS8.png')"]} bgPosition="center" bgRepeat="no-repeat" boxShadow="2xl" bgSize="cover" position="relative" zIndex="0" >
                    <Box boxShadow="2xl" borderRadius="8px" position="absolute" p="10px" bottom="30px" left="-10px" bgColor="primary" w={["95%","90%","70%"]} height={["40%","50%"]} >
                        <Text  fontWeight="600" fontSize={["3xl","xl","2xl" ]}color="terciary" >App de adopción</Text>
                ...
                <GridItem borderRadius="4px" bgImage={["url('https://i.imgur.com/lT1gWYh.png')","url('https://i.imgur.com/5dFQyjJ.png')"]} bgPosition="center" bgRepeat="no-repeat" boxShadow="2xl" bgSize="cover" position="relative" zIndex="0" >
                    <Box boxShadow="2xl" borderRadius="8px" position="absolute" p="10px" bottom="30px" left="-10px" bgColor="primary" w={["95%","90%","70%"]} height={["40%","50%"]} >
                        ...
                        <Text fontSize={["xl","16px"]} color="terciary" >Documentación técnica de conceptos básicos de programación.</Text>
                        <HStack px="10px" position="absolute" bottom="10px" right="0" left="0" justifyContent="space-between"  >
            ...
            <Link display={["inline-block","block"]} _hover={{textDecoration:"none"}} _focus={{outline:"none"}} mt="20px" w={["100%","300px" ]} mx="auto" href="https://github.com/LewisContreras?tab=repositories" isExternal >
