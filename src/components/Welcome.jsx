...
const Welcome = () => {
    return (
        <Center id="welcome" pt={["100px","100px","20px"]} bgColor="primary" minH="100vh" w="100vw" >
            <Flex alignItems="center" textAlign="center" maxW="90%" flexDirection={["column","column","row-reverse"]} justifyContent="center" >
                <Img maxW={["80%","80%","30%"]} maxH={["35vh","35vh","60vh"]} borderRadius="20px" ml={["0px","0px","50px"]} src="https://i.imgur.com/92Ht5DC.jpeg" />
                <VStack  maxW={["auto","auto","50%","40%"]} >
                <Text pt="20px" fontWeight="600" color="terciary" fontSize={["3xl","3xl", "4xl"]} >¡Hola, bienvenido, soy Lewis Contreras!</Text>
